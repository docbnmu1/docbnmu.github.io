...
navActivate = function(){
    ...
    if(firstList.length>1){
        ...
        if(ff.top!=ss.top &&(navTop.getAttribute("data-navorientation").toLowerCase()!="vertical")) {
            setTimeout(function(){
                navActivate()
            },500);
            return;
    ...
    for(var k=0;k<len;k++){
        ...
        if((((navFirstOffset.top != realTop.top || navFirstElement.offsetTop != elem.offsetTop)&&navTop.getAttribute("data-navorientation").toLowerCase()!="vertical")||(window.innerWidth<=640 && (typeof(responsiveTheme)!="undefined" && responsiveTheme==true))||(window.ZS_PreviewMode && parent.responsivePreview=="true") ||((window.innerWidth<800 && mobile && navTop.getAttribute("data-navorientation").toLowerCase()=="vertical") && k>4 && (typeof(responsiveTheme)!="undefined" && responsiveTheme==true)))&& !iconMenu){
            var mMenu=false;
            var span=navMoreLI.getElementsByTagName("span")[0];
            if(k<=2 && window.innerWidth<=640){
                if(navFirstElement){
            ...
            }else if((window.innerWidth<800 && mobile && navTop.getAttribute("data-navorientation").toLowerCase()=="vertical")){//No I18N
                ipadVFix=true;
                if(span){
                    span.innerHTML="&#x2261; Menu";//No I18N
                    navMoreLI.className="navArrow selected";
    ...
    if(navMoreUL.childNodes.length!=0){
        ...
        if(moreMenu==null){
            ...
            if(mMenu==true || ((window.innerWidth<800 && mobile && navTop.getAttribute("data-navorientation").toLowerCase()=="vertical") && (typeof(responsiveTheme)!="undefined" && responsiveTheme==true))){
    ...
    if((mobile && window.innerWidth<640) || (typeof(parent.responsivePreview)!="undefined" && parent.responsivePreview=="true")){
...
navItemTouch = function(ev){
    ...
    if(this.tagName &&((this.tagName.toLowerCase()=="ul" && (!this.getAttribute("navshowing") != null))||(this.tagName.toLowerCase()=="li" && (!this.parentNode.getAttribute("navshowing") != null)))){
        ...
        if(window.innerWidth<700 || ipadVFix){
...
navLeftAlign = function(np2,sm2,px){
    ...
    if(parseInt(sm2.style.left)<5){
        ...
        if(!(sm2.id=="nav-submenu-idMore")){
            if(((np2.id!="navigation" && navAlignHor) ||(!navAlignHor && np2.id!="nav-top"))&& !ipadVFix){
